...
### Fixed
- Eliminate tabbar/content region overlap
- Remove gap row so data grid touches tab bar
## [1.2.4] - 2026-08-13

### Fixed
- Align non-TUI formatter and porcelain output with x1f db separator
## [1.2.3] - 2026-04-05

### Fixed
- Integration test failures in error-path and inspector tests
## [1.2.2] - 2026-04-05

### Fixed
- Version shows 'vdev' when installed via Homebrew
## [1.2.1] - 2026-04-05

### Fixed
- Footer text unreadable and tab close button too narrow
- Widen quit-confirm dialog to fit question text
## [1.2.0] - 2026-04-04
