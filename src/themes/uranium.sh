...
SHQL_THEME_HEADER_BG=$'\033[1;30;48;2;80;186;42m'  # bold dark text on RGB(80,186,42) green
SHQL_THEME_RESET=$'\033[0m'
SHQL_THEME_TABBAR_BG=$'\033[37;100m'               # light text on dark grey (inactive tabs)
